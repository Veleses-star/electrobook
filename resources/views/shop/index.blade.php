<x-app-layout>
    ...
    <div class="py-12 bg-kid-bg dark:bg-dark-bg min-h-screen">
        <div class="max-w-6xl mx-auto px-4">
            ...
            @php
                // Массив для перевода английских названий статусов на русский
                $statusNames = [
                    'Youngster' => 'Молодец!',
                    'Clever' => 'Умный',
                    'Excellent' => 'Отличник',
            ...
            @php
                $categories = [
                    ...
                    'theme'  => ['title' => 'Темы оформления', 'icon' => '🎨'],
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            @foreach($groupedItems[$type] as $item)
                                ...
                                <div class="bg-white dark:bg-dark-card rounded-2xl shadow-lg overflow-hidden border-2 border-gray-100 dark:border-gray-700 hover:border-kid-secondary dark:hover:border-dark-secondary transition-all duration-300">
                                    ...
                                    <div class="p-6">
                                        <h3 class="text-xl font-extrabold text-gray-800 dark:text-gray-100 mb-2">
                                            {{ $item->type === 'status' ? ($statusNames[$item->name] ?? $item->name) : $item->name }}
                                        </h3>
            ...
            @if($items->isEmpty())
                <div class="text-center text-gray-500 dark:text-gray-400 py-12">
                    <p class="text-xl">В магазине пока нет товаров</p>
                </div>
            @endif
        </div>
    </div>
